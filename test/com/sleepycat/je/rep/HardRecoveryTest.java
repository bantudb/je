...
public class HardRecoveryTest extends TestBase {
    ...
    public void doHardRecoveryWithConstructor(boolean setRollbackLimit,
        ...
        try {
            ...
            if (setRollbackLimit) {
                /*
                 * Pretend that the preceding transactions were made durable by
                 * a surreptitious update of the DTVLSN used to determine hard
                 * rollback limits.
                 */
                final RepNode masterRepNode = master.getNonNullRepImpl().getRepNode();
